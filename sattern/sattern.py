...
def main():
    ...
    process_data.predict_next_movement(data=history_data, extracted_data=extracted_data)
    display_stock_data.highlight_pattern(history_data=history_data, extracted_data=extracted_data, min_confidence=0.2)
